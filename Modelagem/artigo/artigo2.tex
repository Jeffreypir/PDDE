...
\begin{tikzpicture}
  ...
  \draw [dashed, black](2,0.5)--(2,0) node[below] {$x_g$}node[below,yshift=-20] {Caso 1};
...
\begin{tikzpicture}
  ...
  \draw [thick, black](5,2)--(6,3)--(8,3)node[left,yshift=8] {$\textbf{D}$};
  \draw [ultra thick, black](2,0.5) circle (0.5mm);
  ...
  \draw [dashed, black](2,0.5)--(0,0.5) node[left] {$f(x_g)$};
  \draw [dashed, black](2,0.5)--(2,0) node[below] {$x_g$}node[below,yshift=-20] {Caso 2} ;
  \draw [dashed, black] (1.5,1.8)--(1.5,0) node[below] {$x_1$};
  \draw [dashed, black] (1.5,1.8)--(0.0,1.8) node[left] {$f(x_1)$};
  \draw [dashed, black](3.8,2.7)--(3.8,0) node[below] {$x_2$};
  \draw [dashed, black](3.5,2.7)--(0.0,2.7) node[above left] {$f(x_2)$};
...
\begin{figure}[!htpb]
  \subfigure[]{
	\includegraphics[width=7cm, height]{simula10.eps}}
\subfigure[]{
	\includegraphics[width=7cm, height]{simulacao18.eps}}
